...
class BaseBuilder:
    ...
    def __init__(
        ...
        self.state.update(folder_path=folder_path,
    ...
    def _epoch_complete(self):
        ...
        for module in [self.model, self.scheduler, self.early_stopping,
                       self.logs_formatter]:
    ...
    def fit(self):
        """Run model training."""
        while self.state.epoch < self.num_epoch and \
                not self.early_stopping.stop:
